...
export default function Item(props) {
  ...
  const dados = createSelector([carrinhoSelect], (select1) => ({
    estaNoCarrinho: select1.some((itemNoCarrinho) => itemNoCarrinho.id === id),
  }));

  const { estaNoCarrinho } = useSelector(dados);
